...
(function () {
  ...
  Polymer({
    ...
    _computeLabelConfig(labels, labelName) {
      console.log("_computeLabelConfig")
    ...
    _observeCopyScoresChange() {
      ...
      console.log("_observeCopyScoresChange");
      console.log(this._labelConfig.copy_scores);
    ...
    _observeCopyScoresChangeInUi() {
      if (this._updatingCopyScores) { return; }
      this._updatingCopyScores = true;
      console.log("_observeCopyScoresChangeInUi");
      console.log(this._copyScores);
      let newCopyScores = [];
