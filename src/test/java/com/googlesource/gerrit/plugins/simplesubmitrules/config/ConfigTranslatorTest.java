...
public class ConfigTranslatorTest {
  ...
  public void checkLabelTranslation() {
    checkTranslation(
        Constants.COPY_MIN_SCORE, LabelType::isCopyMinScore, LabelType::setCopyMinScore);
    checkTranslation(
        Constants.COPY_MAX_SCORE, LabelType::isCopyMaxScore, LabelType::setCopyMaxScore);

    checkTranslation(
        Constants.COPY_ALL_SCORES_IF_NO_CHANGE,
        LabelType::isCopyAllScoresIfNoChange,
        LabelType::setCopyAllScoresIfNoChange);

    checkTranslation(
        Constants.COPY_ALL_SCORES_IF_NO_CODE_CHANGE,
        LabelType::isCopyAllScoresIfNoCodeChange,
        LabelType::setCopyAllScoresIfNoCodeChange);

    checkTranslation(
        Constants.COPY_ALL_SCORES_ON_MERGE_COMMIT_FIRST_PARENT_UPDATE,
        LabelType::isCopyAllScoresOnMergeFirstParentUpdate,
        LabelType::setCopyAllScoresOnMergeFirstParentUpdate);

    checkTranslation(
        Constants.COPY_ALL_SCORES_ON_TRIVIAL_REBASE,
